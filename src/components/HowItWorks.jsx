...
const HowItWorks = () => {
  return (
    <div id="how-it-works" className="bg-base-100 py-12">
            ...
            {steps.map((step, index) => (
              <div key={step.name} className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-base-content">{`Step ${index + 1}: ${step.name}`}</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-base-content/70">{step.description}</dd>
              </div>
            ))}
          </dl>
        </div>

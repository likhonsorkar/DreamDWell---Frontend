...
const EmailActivation = () => {
    ...
    return (
        <main className="min-h-[90vh] flex items-center justify-center p-6 bg-primary/20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-72 h-72 bg-primary rounded-full blur-3xl opacity-20 -z-10"></div>
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-primary rounded-full blur-3xl opacity-20 -z-10"></div>
        <div className="max-w-md w-full bg-white/90 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white p-8 md:p-12 text-center">
            <div className="flex justify-center mb-8">
                <div className="bg-primary p-3 rounded-2xl shadow-lg shadow-primary">
            ...
            {status == "wait" && (<span className="loading loading-bars loading-xl text-primary"></span>)}
            {status == "success" && (
                <div>
                ...
                <Link to="/login" className="btn bg-primary hover:bg-primary border-none text-white w-full h-14 shadow-xl shadow-primary text-lg rounded-2xl font-bold">
                    Go to Login
                </Link>
            </div>)}
            {status == "wrong" && (
                ...
                <div className="space-y-3">
                    <Link to="/" className="btn btn-outline border-primary text-primary hover:bg-primary hover:border-primary w-full h-14 rounded-2xl text-lg font-bold">
                        Back to Home
                    </Link>
                </div>
            </div>)}
